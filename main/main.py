...
def main():
    ...
    while True:
        ...
        if opcao == 'd' and usuario_logado:
            ...
            conta_corrente["saldo"], conta_corrente["extrato"] = depositar(valor_a_depositar,
            ...
            conta_corrente["saldo"], conta_corrente["extrato"] = saque(valor_sacado=valor_a_sacar,
            ...
            extrato(conta_corrente["saldo"], conta_corrente["usuario"]["nome"], extrato=conta_corrente["extrato"])
...
def criar_conta(usuarios):
    ...
    if not usuarios:
        ...
        #usar numero conta -1 como index para criações
        conta_corrente = {'usuario':usuarios[0],
                          'saldo':saldo,
                          'extrato':extrato,
